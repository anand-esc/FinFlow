    ...
    <div className="flex h-screen items-center justify-center bg-slate-50 overflow-hidden relative font-sans">
      ...
      >
          ...
          <button 
             ...
             className="w-full flex items-center justify-center space-x-3 px-6 py-3.5 bg-white hover:bg-slate-200 text-slate-900 rounded-xl font-bold transition-all shadow-md hover:shadow-xl"
          >
